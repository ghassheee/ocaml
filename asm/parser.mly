...
command: 
    | comp jump                 { incr line; C_COMMAND([],$1,$2)        } 
    | dest comp                 { incr line; C_COMMAND($1,$2,NULL)      } 
    | dest comp jump            { incr line; C_COMMAND($1, $2, $3)      }
    | AT symbol                 { incr line; A_COMMAND($2)              }
...
regOI: 
    | reg                       { $1                                    } 
    | NUM                       { match $1 with | 0->ZERO | 1->ONE | _->raise ALUError } 
